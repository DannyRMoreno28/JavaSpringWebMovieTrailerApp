-- Crear la base de datos "organizador_peliculas"
USE [master]
GO
...
-- Cambiar al contexto de la base de datos "organizador_peliculas"
...
-- Agregar restricciones de clave foránea a la tabla "genero_pelicula"
...
-- Establecer la base de datos "organizador_peliculas" en modo lectura y escritura
